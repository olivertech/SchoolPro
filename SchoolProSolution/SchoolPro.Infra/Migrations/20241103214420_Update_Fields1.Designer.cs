...
namespace SchoolPro.Infra.Migrations
{
    ...
    [Migration("20241103214420_Update_Fields1")]
    partial class Update_Fields1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SchoolPro.Core.Entities.Client", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClientKey = "iaxqRaCHDNR5KZrriHVq59U96PedeKTm",
            ...
            modelBuilder.Entity("SchoolPro.Core.Entities.School", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            SchoolKey = "HejGkZngN6A2JzLQ2g5luuye8qSzhmg5"
                        });
                });
